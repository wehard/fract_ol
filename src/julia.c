...
/*   Updated: 2019/12/20 16:19:36 by wkorande         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	plot_julia(t_mlx_data *mlx_data, float width, float height)
{
	...
	c.r = -0.7; //ft_map_range(mlx_data->mouse_x, ft_make_pair_d(0.0, width), ft_make_pair_d(-1.0, 1.0));
	c.i = 0.27015; //ft_map_range(mlx_data->mouse_y, ft_make_pair_d(0.0, height), ft_make_pair_d(-1.0, 1.0));
	cur.y = 0;
	while(cur.y < height)
	{
		cur.x = 0;
